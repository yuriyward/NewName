...
export function SuccessScreen(): JSX.Element {
  return (
    <div className="min-h-screen bg-gradient-to-b from-success-50 via-background to-background text-foreground dark:from-success-950/30">
      <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col items-center justify-center gap-6 px-6 py-10 text-center">
        <div className="relative">
          <div className="absolute -inset-4 animate-pulse rounded-full bg-success-200/50 dark:bg-success-800/30" />
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-success-700 dark:text-success-400">
            All set! 🎉
          </h1>
