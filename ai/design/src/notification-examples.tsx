...
// Utility: Truncate filename in middle, keeping extension visible
// "very-long-filename-that-is-too-long.pdf" → "very-long-fi...is-too-long.pdf"
export const truncateFilenameInMiddle = (
  filename: string,
  maxLength: number = 50,
): string => {
...
// Extended filename variants for length testing
...
// Filename display component with intelligent middle-truncation
// Respects 50vw max-width, applies ellipsis in middle if needed
// Shows full filenames on hover via HeroUI Tooltip
export const FilenameDisplay = ({
  ...
  // On a 1920px screen, 50vw = 960px. With padding and icon, roughly 45-50 chars fits nicely
  // We use a conservative 48 chars as the threshold for applying ellipsis
